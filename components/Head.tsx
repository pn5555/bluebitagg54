...
export const Head: FC<Props> = ({
  ogImage = '',
  title = 'Bluebit NFT Marketplace Aggregator',
  description = 'Bluebit NFT Aggregator',
}) => {
  return (
    <NextHead>
      ...
      <meta name="twitter:site" content="@Bluebit_io" />
      ...
      <meta property="og:image:alt" content="Bluebit NFT Aggregator Banner" />
    </NextHead>
  )
}
